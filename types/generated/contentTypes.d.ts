...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['otomotif', 'foto', 'video']>;
...
export interface ApiPortfolioPortfolio extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imageporto: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiProfileProfile extends Schema.CollectionType {
  ...
  attributes: {
    profileImageUrl: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    name: Attribute.String;
    icon1: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    icon2: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    icon3: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    icons: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    linkcv: Attribute.String;
    status: Attribute.Enumeration<
      ['Available for Freelance', 'Not Available for Freelance']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    imageIcon: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiSkillSkill extends Schema.CollectionType {
  ...
  attributes: {
    imageskill: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    skill: Attribute.String;
    precent: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
